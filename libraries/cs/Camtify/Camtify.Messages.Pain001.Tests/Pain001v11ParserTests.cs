...
/// <summary>
/// Tests for Pain001v11Parser (pain.001.001.11 - latest version).
/// </summary>
public sealed class Pain001v11ParserTests
{
    [Fact]
    public async Task ParseDocumentAsync_SimpleVersion11_ParsesSuccessfully()
    {
        // Arrange
        var xmlPath = Path.Combine("TestData", "pain001_v11_simple.xml");
        ...
        result.Version.ShouldBe("011");
        result.Namespace.ShouldBe("urn:iso:std:iso:20022:tech:xsd:pain.001.001.11");
    }

    [Fact]
    public async Task ParseDocumentAsync_SimpleVersion11_ParsesGroupHeaderCorrectly()
    {
        // Arrange
        var xmlPath = Path.Combine("TestData", "pain001_v11_simple.xml");
        var xml = await File.ReadAllTextAsync(xmlPath);
    ...
    [Fact]
    public async Task ParseDocumentAsync_SimpleVersion11_ParsesPaymentInformationCorrectly()
    {
        // Arrange
        var xmlPath = Path.Combine("TestData", "pain001_v11_simple.xml");
        var xml = await File.ReadAllTextAsync(xmlPath);
  ...
  <CstmrCdtTrfInitn>
    <GrpHdr>
      ...
      <InitgPty><Nm>Test</Nm></InitgPty>
        ...
        // Act & Assert
        parser.Version.ShouldBe("011");
        parser.Namespace.ShouldBe("urn:iso:std:iso:20022:tech:xsd:pain.001.001.11");
    }
}
