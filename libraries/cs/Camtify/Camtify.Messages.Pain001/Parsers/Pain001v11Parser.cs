...
public sealed class Pain001v11Parser :
    Pain001ParserBase<Pain001v11Document>,
    IPain001Parser,
    IStreamingParser<PaymentInformation>
{
    ...
    {
        new MessageIdentifier("pain.001.001.11")
    };
        ...
        CancellationToken cancellationToken)
    {
        ...
        {
            MessageId = new MessageIdentifier("pain.001.001.11"),
            Header = null,
